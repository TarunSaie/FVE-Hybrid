...
export function normalizeBrandConfig(value: Partial<BrandConfig> | null | undefined): BrandConfig {
  return {
    ...
    background_color: value?.background_color || DEFAULT_BRAND_CONFIG.background_color,
    card_color: value?.card_color || DEFAULT_BRAND_CONFIG.card_color,
    foreground_color: value?.foreground_color || DEFAULT_BRAND_CONFIG.foreground_color,
    muted_color: value?.muted_color || DEFAULT_BRAND_CONFIG.muted_color,
    muted_foreground_color: value?.muted_foreground_color || DEFAULT_BRAND_CONFIG.muted_foreground_color,
    border_color: value?.border_color || DEFAULT_BRAND_CONFIG.border_color,
